...
3. Definitions of [causal inference intervention types](visual-guides/Types_of_Interventions.jpg) with examples using pollution data with a corresponding [blog post](https://www.khstats.com/blog/lmtp/lmtp/)
